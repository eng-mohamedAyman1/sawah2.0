import 'package:final_project/core/functions/custom_toast.dart';
import 'package:final_project/core/functions/navigation.dart';
import 'package:final_project/core/utils/app_colors.dart';
import 'package:final_project/core/utils/app_strings.dart';
import 'package:final_project/core/widgets/custom_btn.dart';
import 'package:final_project/features/auth/presentation/auth_cubit/cubit/auth_cubit.dart';
import 'package:final_project/features/auth/presentation/auth_cubit/cubit/auth_state.dart';
import 'package:final_project/features/auth/presentation/widgets/custom_text_field.dart';
import 'package:final_project/features/auth/presentation/widgets/terms_and_condition_widget.dart';
    ...
    return BlocConsumer<AuthCubit, AuthState>(
      listener: (context, state) {
        if (state is SignupSuccessState) {
          ...
          showToast("jkhm" +state.errMessage);
        }
      },
